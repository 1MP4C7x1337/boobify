   ...
   <div class="wrapper">
      ...
      <div class="iq-sidebar">
         <div class="iq-sidebar-logo d-flex justify-content-between">
            <a href="{{ route('user_dashboard', 'orders') }}">
         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     <a href="{{ route('user_dashboard', 'orders') }}" class="iq-waves-effect"><i class="ion-archive"></i><span>Orders</span></a>
                  </li>
                  <li>
                  ...
                  <li>
                     <a href="{{ route('user_dashboard', 'withdraw') }}" class="iq-waves-effect"><i class="fa fa-money" aria-hidden="true"></i><span>Withdraw</span></a>
                  </li>
               </ul>
            </nav>
            <div class="p-3"></div>
