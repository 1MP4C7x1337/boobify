         ...
         <div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li>
                     <a href="{{ route('dashboard', 'orders') }}" class="iq-waves-effect"><i class="ion-archive"></i><span>Orders</span></a>
                  </li>
                  <li>
                     <a href="{{ route('dashboard', 'earnings') }}" class="iq-waves-effect"><i class="fa fa-money" aria-hidden="true"></i><span>Earnings</span></a>
                  </li>
                  <li>
                     <a href="{{ route('dashboard', 'services') }}" class="iq-waves-effect"><i class="fa fa-server" aria-hidden="true"></i><span>Services</span></a>
                  </li>
                  <li>
