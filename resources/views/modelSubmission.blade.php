                        ...
                        <div class="sign-in-from">
                            ...
                            <form method="post" action="{{ route('register') }}" class="mt-4" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control mb-0 @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" placeholder="Enter email" required>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="age" class="form-control mb-0 @error('age') is-invalid @enderror" id="age" value="{{ old('age') }}" placeholder="Enter age" required>
                                    @error('age')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
